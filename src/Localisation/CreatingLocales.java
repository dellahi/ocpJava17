...
public class CreatingLocales {
    public static void main(String[] args) {
        ...
        Locale locArabicMauritania = new Locale.Builder()
                ...
                .setLanguage("ar")  // language second
                .build();
        System.out.println(locArabicMauritania);  // ar_MR
        System.out.println(locArabicMauritania.getDisplayCountry()); //Mauritanie
        System.out.println(locArabicMauritania.getDisplayLanguage()); //arabe
        System.out.println("root : " + Locale.ROOT);
    }
