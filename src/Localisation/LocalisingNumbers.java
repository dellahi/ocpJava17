...
public class LocalisingNumbers {
    private static Locale locArabicMauritania = new Locale.Builder()
...
//        parseCurrencies();
    ...
    public static void formatNumbers(){
        ...
        System.out.println(NumberFormat.getNumberInstance(locArabicMauritania).format(n));// 77 000,11
    }
    public static void formatCurrencies(){
        ...
        System.out.println(NumberFormat.getCurrencyInstance(locArabicMauritania).format(n));      // £23.22
    }
